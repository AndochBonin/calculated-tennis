...
type Market struct {
	...
	RewardsMaxSpread             decimal.Decimal `json:"rewardsMaxSpread"`
	Spread                       decimal.Decimal `json:"spread"`
	AutomaticallyResolved        bool            `json:"automaticallyResolved"`
	OneDayPriceChange            decimal.Decimal `json:"oneDayPriceChange"`
	OneHourPriceChange           decimal.Decimal `json:"oneHourPriceChange"`
	OneWeekPriceChange           decimal.Decimal `json:"oneWeekPriceChange"`
	OneMonthPriceChange          decimal.Decimal `json:"oneMonthPriceChange"`
	OneYearPriceChange           decimal.Decimal `json:"oneYearPriceChange"`
