...
func TestBuildOrder_goldenVector_fixedSalt(t *testing.T) {
	// Deterministic salt via fixed rand.Read; guards EIP-712 / POLY_1271 wire regressions.
	prev := randReadFn
	...
	p, err := s.BuildOrder(tokenID, order.SideBuy, price, size, false, expiration, ts, deposit, 3)
	if err != nil {
		t.Fatalf("BuildOrder: %v", err)
	}

	const wantSalt int64 = 4774451407313060418
	const wantSignature = ""
	if p.Salt != wantSalt {
		t.Fatalf("Salt: got %d want %d", p.Salt, wantSalt)
	}
	if p.MakerAmount != "5000000" || p.TakerAmount != "10000000" {
		t.Fatalf("amounts: maker=%q taker=%q", p.MakerAmount, p.TakerAmount)
	}
	if p.Signature != wantSignature {
		t.Fatalf("Signature: got %q want %q", p.Signature, wantSignature)
	}
}
